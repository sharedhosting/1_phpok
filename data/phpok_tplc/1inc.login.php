...
<div class="border_no_top">
	<table>
	<tr>
		<td width="40px" align="right" height="21px"><img src="templates/zh/default/images/user_profile.gif"></td>
		<td><a href="my.php?file=usercp">个人信息</a></td>
	</tr>
	<tr>
		<td align="right" height="21px"><img src="templates/zh/default/images/user_order.gif"></td>
		<td><a href="my.php?file=order">我的订单</a></td>
	</tr>
	<tr>
		<td align="right" height="21px"><img src="templates/zh/default/images/user_feedback.gif"></td>
		<td><a href="my.php?file=feedback">信息反馈</a></td>
	</tr>
	<tr>
		<td align="right" height="21px"><img src="templates/zh/default/images/user_logout.gif"></td>
