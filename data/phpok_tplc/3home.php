...
<div id="left_2">
	...
	<div style="padding-top:3px;padding-bottom:3px;">
		<div class="float_left" style="width:365px">
		...
		<div class="float_left" style="width:361px;_width:365px;padding-left:2px;padding-right:2px;">
...
<div id="right_2">
	...
	<div class="space_between"><img src="templates/zh/crystal_blue/images/blank.gif" border="0" width="1" height="1"></div>
	...
	<div>
		...
		<div class="border_no_top"><div style="padding:5px;">　　<?php echo $special[content];?><div align="right"><a href="<?php echo $special[url];?>"<?php echo $special[target];?>><img src="templates/zh/crystal_blue/images/more.jpg" border="0"></a></div></div></div>
		<?php unset($special);?>
	</div>
	<div class="space_between"><div class="space_between"></div></div>
	<div>
