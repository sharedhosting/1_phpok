		...
		<div class="list_out" onmouseover="this.className='list_over'" onmouseout="this.className='list_out'">
			...
			<tr>
				<td width="120px" align="center">
					...
					<?php }else{ ?>
					<a href="msg.php?id=<?php echo $value[id];?>" title="<?php echo $value[subject];?>"><img src="templates/en/crystal_blue/images/nopicture.gif" border="0" width="100px" height="100px" style="border:1px #D2DFE6 solid;"></a>
					<?php } ?>
				</td>
				<td valign="top" width="600px">
					<div class="wtr">Product: <a href="msg.php?id=<?php echo $value[id];?>" title="<?php echo $value[subject];?>" style="<?php echo $value[style];?>"><?php echo $value[cut_subject];?></a></div>
					<div class="dtr">Cate: <a href="list.php?id=<?php echo $value[cateid];?>" title="<?php echo $value[catename];?>"><?php echo $value[catename];?></a></div>
					<div class="wtr">Standard: <?php echo $value[ext_standard];?></div>
					<div class="dtr">Number: <?php echo $value[ext_number];?></div>
					<!--<div class="wtr">Market Price: $ <?php echo $value[ext_marketprice];?> &nbsp; &nbsp; Shop Price: $<span style="color:red;"><?php echo $value[ext_shopprice];?></span></div>-->
					<div class="pro_dtr"><?php echo $value[ext_docket];?></div>
					<div class="pro_tr" align="right">
						<a href="msg.php?id=<?php echo $value[id];?>"><img src="templates/en/crystal_blue/images/product_msg.gif" border="0"></a>
						<a href="buy.php?id=<?php echo $value[id];?>"><img src="templates/en/crystal_blue/images/product_buy.gif" border="0"></a>
					</div>
				</td>
			</tr>
			</table>
