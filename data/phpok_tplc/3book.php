...
<div id="left_2">
	...
	<div class="border_no_top">
		...
		<div style="padding:5px;">
			<div style="border:1px #D2DFE6 dashed;padding:5px;"><span style="color:red;">管理员回复：</span><?php echo $value[reply];?></div>
		</div>
		<?php } ?>
		<div align="right"><a href="#addbook" style="color:darkred;">发表新留言</a>&nbsp; &nbsp;</div>
	</div>
	...
	<div class="border_no_top">
		...
		<?php } ?>
		<tr>
			<td align="right"><span style="color:red;">*</span> 主题：</td>
